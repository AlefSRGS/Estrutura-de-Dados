...
public class CadastroProdutos {
    ...
    public int consultaProdutos(String codigoProduto){
        for(int posicaoProdutoEstoque = 0; posicaoProdutoEstoque < qntProdutoEstoque; posicaoProdutoEstoque++){
    ...
    public String exibirDadosProdutoUnico(String codigoProduto){
        return estoqueProdutos[consultaProdutos(codigoProduto)].toString();
    }
    ...
    public void removerCadastroProduto(String codigoProduto){
        ...
        if(posicaoProduto == -1){
            ...
            for (int i = posicaoProduto; i < qntProdutoEstoque - 1; i++) {
                estoqueProdutos[i] = estoqueProdutos[i + 1];
            }
            estoqueProdutos[qntProdutoEstoque - 1] = null;
            qntProdutoEstoque--;
